...
<section id="about" class="py-20">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center md:items-start gap-12">
    ...
    <div class="md:w-1/2">
      ...
      <!-- Photo Collage (Shown first on Mobile, normal on Desktop) -->
      <div class="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-8 md:order-none order-first">
      ...
      <!-- Title -->
      <h2 class="text-5xl font-dmserif font-bold text-blue-700 mb-4">
        <span class="italic">About </span><span class="font-gabarito">Veritas School</span>
      </h2>
