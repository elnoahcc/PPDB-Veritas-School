...
<nav class="font-gabarito fixed top-6 left-6 right-6 z-50 bg-white/80 backdrop-blur-md shadow-xl rounded-3xl py-4 flex items-center justify-between px-10 transition-all duration-300">
